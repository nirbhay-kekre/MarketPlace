				...
				<div class="row">
					<div class="col-md-10 col-md-offset-1">
						...
						<div class="row contact-info-wrap">
							...
							<div class="col-md-3">
								<p><span><i class="icon-paperplane"></i></span> <a href="mailto:akshjaiswalfree@gmail.com">akshjaiswalfree@gmail.com</a></p>
							</div>
							<div class="col-md-3">
								<p><span><i class="icon-globe"></i></span> <a href="#">sinnonyms.com</a></p>
							</div>
						</div>
					</div>
					<div class="col-md-10 col-md-offset-1">
